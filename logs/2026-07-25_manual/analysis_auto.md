# 자동분석 — /home/suri/suridoksuri/logs/2026-07-25_manual

(analyze_flight.py 자동생성 — 해석 없이 사실만. notes.md에 결론 작성 시 이 파일 인용)

## 이 폴더의 다른 ulog (참고, 미분석)
- `log_140_2026-07-25-01-52-08.ulg`: 0.9s
- `log_142_2026-07-25-03-14-00.ulg`: 101.6s
- `log_143_2026-07-25-06-31-52.ulg`: 1.0s
- `log_144_2026-07-25-06-31-54.ulg`: 1.0s
- `log_145_2026-07-25-06-32-10.ulg`: 1.0s
- `log_146_2026-07-25-06-33-54.ulg`: 1.0s
- `log_147_2026-07-25-06-36-58.ulg`: 1.0s
- `log_148_2026-07-25-06-37-00.ulg`: 2.2s
- `log_149_2026-07-25-06-37-02.ulg`: 1.0s
- `log_150_2026-07-25-06-52-04.ulg`: 1.0s
- `log_151_2026-07-25-06-53-34.ulg`: 1.0s
- `log_152_2026-07-25-06-55-04.ulg`: 38.6s

## 주 로그: `log_141_2026-07-25-01-55-08.ulg` (114.45s)
...
### 고도
- home_position AMSL=373.79m, EKF ref_alt AMSL=372.51m
- AGL 최대 24.5m (t=42.95s), 최소 -7.32m (t=87.84s), 종료시 -6.24m

### 모드권한 타임라인
| t(s) | nav_state | user_intention | failsafe | arming | 분류 |
|---|---|---|---|---|---|
| 0.49 | 0:MANUAL | 0:MANUAL | 0 | ARMED | AUTO_RECOVERY_OR_UNCLASSIFIED |
| 9.8 | 2:POSCTL | 2:POSCTL | 0 | ARMED | INTENTIONAL_CHANGE |
...
### 자세
- roll 최대|값|=23.96° (t=31.1s)
- pitch 최대|값|=26.66° (t=35.25s)
- roll 목표(setpoint) 최대|값|=25.86° (t=30.8s) — 이 값이 실측 roll_deg_max_abs 근처까지 크면 세트포인트 자체 결함(순간점프 등) 의심 — 0 근처로 작으면 컨트롤러는 정상 수평을 명령했는데 실제가 못 따라간 것.
- roll rate 이상조짐 후보: t=5.29s (-14.3deg/s)
- pitch rate 이상조짐 후보: t=3.83s (8.2deg/s)
- yaw rate 이상조짐 후보: t=4.32s (-8.2deg/s)
...
### 모터별 커맨드 (0~1)
- 0:전우: mean=0.808 max=1.0 min=0.0
- 1:후좌: mean=0.66 max=1.0 min=0.0
- 2:전좌: mean=0.522 max=1.0 min=0.0
- 3:후우: mean=0.656 max=1.0 min=0.0
- 4:중중: mean=nan max=nan min=nan

### 배터리
- 휴지전압 16.87V, 부하중 최저 11.44V, 전류 최대 44.2A
- remaining: 1.0 → 0.4

### 실패감지기
- imbalanced_prop_metric_max_abs: -10.602
- fd_imbalanced_prop_ever_nonzero: False
- fd_motor_ever_nonzero: False
- motor_failure_mask_ever_nonzero: False

### 이함(liftoff) 순간
- ground_contact 1→0 시점: t=2.92s

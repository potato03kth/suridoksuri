# 자동분석 — logs/2026-07-30_flight02

(analyze_flight.py 자동생성 — 해석 없이 사실만. notes.md에 결론 작성 시 이 파일 인용)

## 주 로그: `log_269_2026-07-30-01-15-54.ulg` (125.87s)
...
### 고도
- home_position AMSL=18.53m, EKF ref_alt AMSL=19.72m
- AGL 최대 20.07m (t=84.07s), 최소 -0.1m (t=3.67s), 종료시 0.64m
...
| 0.51 | 17:AUTO_TAKEOFF | 17:AUTO_TAKEOFF | 0 | ARMED | INTENTIONAL_CHANGE |
| 18.67 | 4:AUTO_LOITER | 4:AUTO_LOITER | 0 | ARMED | INTENTIONAL_CHANGE |
| 21.8 | 14:OFFBOARD | 14:OFFBOARD | 0 | ARMED | INTENTIONAL_CHANGE |
| 106.15 | 2:POSCTL | 2:POSCTL | 0 | ARMED | INTENTIONAL_CHANGE |
...
### 자세
- roll 최대|값|=24.92° (t=119.02s)
- pitch 최대|값|=50.03° (t=38.97s)
- roll 목표(setpoint) 최대|값|=17.38° (t=119.57s) — 이 값이 실측 roll_deg_max_abs 근처까지 크면 세트포인트 자체 결함(순간점프 등) 의심 — 0 근처로 작으면 컨트롤러는 정상 수평을 명령했는데 실제가 못 따라간 것.
- roll rate 이상조짐 후보: t=3.73s (-8.8deg/s)
- pitch rate 이상조짐 후보: t=4.15s (10.1deg/s)
- yaw rate 이상조짐 후보: t=3.73s (8.6deg/s)
